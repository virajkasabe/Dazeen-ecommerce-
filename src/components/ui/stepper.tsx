...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'm-0.5 rounded-full bg-[#E7E5E4] group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:flex-1',
        className,
      )}
    />
  );
...
function StepperDescription({ children, className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div data-slot="stepper-description" data-state={state} className={cn('text-xs text-stone-500', className)}>
      {children}
    </div>
  );
}
