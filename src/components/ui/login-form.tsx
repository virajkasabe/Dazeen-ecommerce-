...
export function SmokeyBackground({
  ...
  color = "#B4942B", // Adapted to Dazeen warm gold/amber accent for deep blend
  className = "",
...
export function LoginForm() {
  return (
    <div className="w-full max-w-sm p-8 space-y-6 bg-stone-900/40 backdrop-blur-lg rounded-2xl border border-white/10 shadow-2xl">
      <div className="text-center">
        <h2 className="text-3xl font-serif font-black text-white">Welcome Back</h2>
        <p className="mt-2 text-sm text-stone-300">Sign in to continue</p>
      </div>
      <form className="space-y-8">
        ...
        <div className="relative z-0">
          <input
            type="email"
            id="floating_email"
            className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-stone-600 appearance-none focus:outline-none focus:ring-0 focus:border-amber-400 peer"
            placeholder=" " 
            required
          />
          <label
            htmlFor="floating_email"
            className="absolute text-sm text-stone-300 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-amber-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
        ...
        <div className="flex items-center justify-between">
          <a href="#" className="text-xs text-stone-300 hover:text-white transition">Forgot Password?</a>
        </div>
        
        <button
          type="submit"
          className="group w-full flex items-center justify-center py-3 px-4 bg-amber-500 hover:bg-amber-600 rounded-lg text-stone-950 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-stone-900 focus:ring-amber-400 transition-all duration-300"
        >
          Sign In
        ...
        <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-4 text-stone-400 text-xs font-mono">OR CONTINUE WITH</span>
            <div className="flex-grow border-t border-stone-700/50"></div>
        </div>
        ...
        <button
          type="button"
          className="w-full flex items-center justify-center py-2.5 px-4 bg-white/90 hover:bg-white rounded-lg text-stone-700 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-stone-900 focus:ring-amber-400 transition-all duration-300"
        >
       ...
       <p className="text-center text-xs text-stone-400">
        Don't have an account? <a href="#" className="font-semibold text-amber-400 hover:text-amber-300 transition">Sign Up</a>
      </p>
    </div>
  );
}
